    ...
    return (
        <div className="footer py-5 opacity-80">
            <div className="footer-text text-xs">
                ...
                <p className="text-sm leading-7">University of Florida Association for Computing Machinery</p>
                <p className="text-sm leading-7">“The Fishbowl” Stadium Rd, Gainesville, FL 32603</p>
                <p className="text-sm leading-7">Designed by the <b>ACMake Design Team</b></p>
            </div>
