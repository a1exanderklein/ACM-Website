...
function SIGs() {
    ...
    const [isMobile, setIsMobile] = useState(window.innerWidth < 872 || window.innerHeight < 1150); // width that makes the cards stack

    useEffect(() => {
        const handleResize = () => {
            setIsMobile(window.innerWidth < 872 || window.innerHeight < 1150);
        };
