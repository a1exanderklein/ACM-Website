      ...
      <div id='ACMstats' className='flex justify-evenly pt-12'>
        ...
        <div className="flex-col">
          <div className="text-center">
            <p className="font-bold gradient-text1 text-5xl">20</p>
            <p className="text-lg">Lifetime Sponsors</p>
          </div>
        </div>
        <div className="flex-col">
          <div className="text-center">
            <p className="font-bold gradient-text2 text-5xl">#1</p>
        ...
        <div className="flex-col">
          <div className="text-center">
            <p className="font-bold gradient-text3 text-5xl">1,900+</p>
